...
function is_set_api_key(cr)
	if settings.weather.api_key == nil then
		...
		error_text_2 ="The 'OPENWEATHER_API_KEY' environment variable must be exported!"
		...
		error_text_3 ="   1. Sign up on http://openweathermap.org to get an API key."
		...
		error_text_4 ="   2. After the registration Check your e-mail, the API key should be sent!"
		...
		error_text_5 ="   3. Open a terminal and export the API key:"
		...
		error_text_6 ="       export OPENWEATHER_API_KEY=<YOUR-API-KEY>"
